...
def _get_attention_functions() -> tuple[Callable, Callable, Callable, Callable]:
    ...
    if is_cuda_available:
        try:
            ...
            # Fall back to the torch-based implementation when flash_attn is
            # unavailable or its CUDA extension is ABI-incompatible with the
            # current torch/runtime stack.
